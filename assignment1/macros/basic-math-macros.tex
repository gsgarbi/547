...
\newcommand{\csum}[1][n]{\sum_{#1 \geq 1}}
\newcommand{\cunion}[1][n]{\cup_{#1 \geq 1}}

\def\K{\cal{K}}
\def\sa{$\sigma$-algebra on $E$ \ }
\newcommand{\comp}[1]{E \setminus{#1} }
...
\def\union{A \cup B \cup C}

\def\sD{\sigma D}

\newcommand{\s}[1]{\sigma \cal{#1} }
